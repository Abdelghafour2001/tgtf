...
class Ui_self(object):
    def setupUi_(self,SplashScreen):
        ...
        self.label.setStyleSheet("#label{border-image:none;color:blue}")
        self.label.setText("")
        ...
        self.label_2.setStyleSheet("#label_2{border-image:none;color:blue}")
        self.label_2.setText("Attendance App")
